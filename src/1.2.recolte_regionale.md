...
<h3>Répartition de la récolte régionale de "${choix_liste_essences1}" en ${choix_liste_annee1} dans la région "${choix_liste_regions1}" : </h3>
...
<br>
  ...
  <i>Graphique 1 : Répartition de la récolte régionale de "${choix_liste_essences1}" en ${choix_liste_annee1} dans la région "${choix_liste_regions1}".<br> Source : Enquête EXF-SRI</i>
  </div>
</div>
...
const graph_recolte_reg_hist = Plot.plot({
  ...
  marks: [
    ...
    Plot.dot(data_evol_recolte_reg1_filtree_final, {x: "Annee", y: "Volume", fill: "Region",
    ...
    Plot.dot(data_evol_recolte_reg2_filtree_final, {x: "Annee", y: "Volume", fill: "Region",
                     title: d => `${d.Region}\n${d.Annee}: ${d.Volume.toFixed(0)} milliers de m3 ronds sur écorce de ${d.Recolte}`})
  ]
})
```
