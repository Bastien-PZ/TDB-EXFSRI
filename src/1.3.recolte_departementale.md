...
<div style="width: 2000px; height: 500px; overflow: hidden; border: 0px solid #999999;">
  ${treemap_recolte_dep}
  <br><br>
...
const test4 = fin.filter(lignes_fichier_recolte_init => lignes_fichier_recolte_init.Département === choix_liste_departements1);
...
```js
const treemap_recolte_dep = Treemap(test4_with_agg, {
