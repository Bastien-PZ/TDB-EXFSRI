...
<h3>Cartes de l'évolution de la récolte nationale de  "${choix_liste_essences}" entre ${choix_liste_annee} et ${choix_liste_annee} : </h3>

<table style="border-collapse: collapse;">
  <tr>
    <td style="border: none; padding: 10px;">
      <div style="width: 450px; height: 500px; overflow: hidden; border: 0px solid #999999;">
        ${map_evol_recolte_dep}
        <br><br>
        <i>Carte 3 : Evolution de la récolte départementale de  "${choix_liste_essences}"</i>
        <i> entre ${choix_liste_annee} et  ${choix_liste_annee}. <br> Source : Enquête EXF-SRI</i>
      </div>
    </td>
    <td style="border: none; padding: 50px;">
    </td>
    <td style="border: none; padding: 10px;">
      <div style="width: 450px; height: 500px; overflow: hidden; border: 0px solid #999999;">
        ${map_evol_recolte_reg}
        <br><br>
        <i>Carte 4 : Evolution de la récolte départementale de  "${choix_liste_essences}"</i>
        <i> entre ${choix_liste_annee} et  ${choix_liste_annee}. <br>Source : Enquête EXF-SRI<i>
      </div>
    </td>
  </tr>
...
```js
const l = view(Inputs.range([0, 100], {step: 1, label: "", value: 25}))
```

-----------------------

<h3>Evolution de la récolte nationale de "${choix_liste_essences}" entre ${choix_liste_annee} et ${choix_liste_annee} : </h3>
