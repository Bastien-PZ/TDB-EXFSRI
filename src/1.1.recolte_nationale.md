...
*Carte 1 : récolte régionale de  "${choix_liste_essences}" en ${choix_liste_annee}. Source : Enquête EXF-SRI*

Ajustez la taille des bulles de la carte ci-dessus avec ce curseur :

```js
const l = view(Inputs.range([0, 100], {step: 1, label: ""}))
```
...
<table style="border-collapse: collapse;">
  <tr>
    <td style="border: none; padding: 10px;">
      <div style="width: 400px; height: 400px; overflow: hidden; border: 1px solid #999999;">
        ${map_recolte_dep}
      </div>
    </td>
    <td style="border: none; padding: 10px;">
